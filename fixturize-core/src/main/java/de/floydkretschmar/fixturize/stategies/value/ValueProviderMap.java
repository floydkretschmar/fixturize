...
import de.floydkretschmar.fixturize.stategies.value.providers.custom.BooleanValueProvider;
import de.floydkretschmar.fixturize.stategies.value.providers.custom.ByteValueProvider;
import de.floydkretschmar.fixturize.stategies.value.providers.custom.CharacterValueProvider;
import de.floydkretschmar.fixturize.stategies.value.providers.custom.ContainerValueProvider;
import de.floydkretschmar.fixturize.stategies.value.providers.custom.DoubleValueProvider;
import de.floydkretschmar.fixturize.stategies.value.providers.custom.FloatValueProvider;
import de.floydkretschmar.fixturize.stategies.value.providers.custom.IntegerValueProvider;
import de.floydkretschmar.fixturize.stategies.value.providers.custom.LongValueProvider;
import de.floydkretschmar.fixturize.stategies.value.providers.custom.ShortValueProvider;
import de.floydkretschmar.fixturize.stategies.value.providers.custom.StringValueProvider;
import de.floydkretschmar.fixturize.stategies.value.providers.custom.UUIDValueProvider;
